...
import img61 from "@/assets/Products/61.png";
...
export const Products: productsIndexed = {
  ...
  // GM6 series of AC servo spindle motors consist of stator, rotor, low-noise fans, and high-precision encoder (not required for open-loop control). Based on the structural optimization design and magnetic circuit optimization, GM7 series of AC servo spindle motors adopt the special className F insulation, complete machining, and high-precision dynamic balancing process.
  //           `,
  //         features: `
...
export const Footers: footersIndexed = {
  Acerca: {
    list: [
      { name: "EnterpriseDescription", route: "/about" },
      { name: "MisVis", route: "/about" },
    ],
  },
  Productos: {
    list: [
